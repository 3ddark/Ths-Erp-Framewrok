...
type
  ...
  private
    ...
    FPersonelAdSoyad: TFieldDB; //bu bilgi trigger ile otomatik olarak '$AD $SOYAD' arada boþluk olacak þekilde birleþtiriyor
    FTelefon1: TFieldDB;
    FTelefon2: TFieldDB;
  ...
  public
    ...
    Property PersonelAdSoyad: TFieldDB read FPersonelAdSoyad write FPersonelAdSoyad;  //bu bilgi trigger ile otomatik olarak '$AD $SOYAD' arada boþluk olacak þekilde birleþtiriyor
  ...
  begin
    ...
    begin
      ...
      SQL.Text := Database.GetSQLInsertCmd(TableName, QUERY_PARAM_CHAR, [
        ...
        //FPersonelAdSoyad.FieldName, //bu bilgi trigger ile otomatik olarak '$AD $SOYAD' arada boþluk olacak þekilde birleþtiriyor
        FTelefon1.FieldName,
        FTelefon2.FieldName,
      ...
      //NewParamForQuery(QueryOfInsert, FPersonelAdSoyad);  //bu bilgi trigger ile otomatik olarak '$AD $SOYAD' arada boþluk olacak þekilde birleþtiriyor
...
begin
  ...
  begin
    ...
    begin
      ...
      //NewParamForQuery(QueryOfUpdate, FPersonelAdSoyad);  //bu bilgi trigger ile otomatik olarak '$AD $SOYAD' arada boþluk olacak þekilde birleþtiriyor
