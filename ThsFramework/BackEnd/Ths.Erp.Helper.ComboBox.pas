...
begin
  if Control.ClassType = TCombobox then
  begin
    ...
    begin
      ...
      Brush.Color := TCombobox(Control).FColorDefault;
      if TCombobox(Control).thsRequiredData then
        Brush.Color := TCombobox(Control).FColorRequiredData;
      if TCombobox(Control).Focused then
        Brush.Color := TCombobox(Control).FColorActive;
    end
    else
    begin
...
procedure TCombobox.CreateParams(var pParams: TCreateParams);
const
...
function TCombobox.LowCase(pKey: Char): Char;
begin
...
function TCombobox.IntegerKeyControl(pKey: Char): Char;
begin
...
function TCombobox.DateKeyControl(pKey: Char): Char;
begin
...
procedure TCombobox.SetAlignment(const pValue: TAlignment);
begin
  FAlignment := pValue;
end;

function TCombobox.FloatKeyControl(pKey: Char; pDecimalDigits: Integer): Char;
var
...
function TCombobox.ValidateDate(): Boolean;
var
...
function TCombobox.MoneyKeyControl(pKey: Char; pDecimalDigits: Integer): Char;
var
