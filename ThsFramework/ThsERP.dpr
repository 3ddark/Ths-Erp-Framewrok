...
uses
  ...
  Ths.Erp.Database.Table.SysCountry in 'BackEnd\Ths.Erp.Database.Table.SysCountry.pas',
  ...
  ufrmSysCountries in 'Forms\OutputForms\DbGrid\ufrmSysCountries.pas' {frmSysCountries},
  ufrmSysCountry in 'Forms\InputForms\ufrmSysCountry.pas' {frmSysCountry},
  Ths.Erp.Constants in 'BackEnd\Ths.Erp.Constants.pas',
  ufrmSysCity in 'Forms\InputForms\ufrmSysCity.pas' {frmSysCity},
  ufrmAbout in 'Forms\ufrmAbout.pas' {frmAbout},
  Ths.Erp.Database.Table.SysCity in 'BackEnd\Ths.Erp.Database.Table.SysCity.pas',
  ufrmSysCities in 'Forms\OutputForms\DbGrid\ufrmSysCities.pas' {frmSysCities},
  ...
  Ths.Erp.Database.Table.AyarPrsAskerlikDurumu in 'BackEnd\Ths.Erp.Database.Table.AyarPrsAskerlikDurumu.pas',
  ufrmAyarPrsAskerlikDurumlari in 'Forms\OutputForms\DbGrid\ufrmAyarPrsAskerlikDurumlari.pas' {frmAyarPersonelAskerlikDurumlari},
  ufrmAyarPrsAskerlikDurumu in 'Forms\InputForms\ufrmAyarPrsAskerlikDurumu.pas' {frmAyarPersonelAskerlikDurumu},
  Ths.Erp.Database.Table.AyarPrsBolum in 'BackEnd\Ths.Erp.Database.Table.AyarPrsBolum.pas',
  ufrmAyarPrsBolumler in 'Forms\OutputForms\DbGrid\ufrmAyarPrsBolumler.pas' {frmAyarPersonelBolumler},
  ufrmAyarPrsBolum in 'Forms\InputForms\ufrmAyarPrsBolum.pas' {frmAyarPersonelBolum},
  Ths.Erp.Database.Table.AyarPrsBirim in 'BackEnd\Ths.Erp.Database.Table.AyarPrsBirim.pas',
  ufrmAyarPrsBirimler in 'Forms\OutputForms\DbGrid\ufrmAyarPrsBirimler.pas' {frmAyarPersonelBirimler},
  ufrmAyarPrsBirim in 'Forms\InputForms\ufrmAyarPrsBirim.pas' {frmAyarPersonelBirim},
  Ths.Erp.Database.Table.AyarPrsGorev in 'BackEnd\Ths.Erp.Database.Table.AyarPrsGorev.pas',
  ufrmAyarPrsGorevler in 'Forms\OutputForms\DbGrid\ufrmAyarPrsGorevler.pas' {frmAyarPersonelGorevler},
  ufrmAyarPrsGorev in 'Forms\InputForms\ufrmAyarPrsGorev.pas' {frmAyarPersonelGorev},
  ...
  Ths.Erp.Database.Table.AyarStkStokTipi in 'BackEnd\Ths.Erp.Database.Table.AyarStkStokTipi.pas',
  ...
  Ths.Erp.Database.Table.AyarStkCinsAilesi in 'BackEnd\Ths.Erp.Database.Table.AyarStkCinsAilesi.pas',
  ufrmStokCinsAileleri in 'Forms\OutputForms\DbGrid\ufrmStokCinsAileleri.pas' {frmStokCinsAileleri},
  ufrmStokCinsAilesi in 'Forms\InputForms\ufrmStokCinsAilesi.pas' {frmStokCinsAilesi},
  Ths.Erp.Database.Table.AyarStkCinsOzelligi in 'BackEnd\Ths.Erp.Database.Table.AyarStkCinsOzelligi.pas',
  ufrmStokCinsOzellikleri in 'Forms\OutputForms\DbGrid\ufrmStokCinsOzellikleri.pas' {frmStokCinsOzellikleri},
  ufrmStokCinsOzelligi in 'Forms\InputForms\ufrmStokCinsOzelligi.pas' {frmStokCinsOzelligi},
  ...
  Ths.Erp.Database.Table.AyarStkStokGrubuTuru in 'BackEnd\Ths.Erp.Database.Table.AyarStkStokGrubuTuru.pas',
  ...
  Ths.Erp.Database.Table.AyarStkStokGrubu in 'BackEnd\Ths.Erp.Database.Table.AyarStkStokGrubu.pas',
  ...
  Ths.Erp.Database.Table.AyarPrsPersonelTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsPersonelTipi.pas',
  ufrmAyarPrsPersonelTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsPersonelTipleri.pas' {frmAyarPersonelTipleri},
  ufrmAyarPrsPersonelTipi in 'Forms\InputForms\ufrmAyarPrsPersonelTipi.pas' {frmAyarPersonelTipi},
  Ths.Erp.Database.Table.AyarPrsCinsiyet in 'BackEnd\Ths.Erp.Database.Table.AyarPrsCinsiyet.pas',
  ufrmAyarPrsCinsiyetler in 'Forms\OutputForms\DbGrid\ufrmAyarPrsCinsiyetler.pas' {frmAyarPersonelCinsiyetler},
  ufrmAyarPrsCinsiyet in 'Forms\InputForms\ufrmAyarPrsCinsiyet.pas' {frmAyarCinsiyet},
  Ths.Erp.Database.Table.AyarPrsEgitimSeviyesi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsEgitimSeviyesi.pas',
  ufrmAyarPrsEgitimSeviyeleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsEgitimSeviyeleri.pas' {frmAyarPrsEgitimSeviyeleri},
  ufrmAyarPrsEgitimSeviyesi in 'Forms\InputForms\ufrmAyarPrsEgitimSeviyesi.pas' {frmAyarPrsEgitimSeviyesi},
  Ths.Erp.Database.Table.AyarPrsRaporTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsRaporTipi.pas',
  ufrmAyarPrsRaporTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsRaporTipleri.pas' {frmAyarPersonelRaporTipleri},
  ufrmAyarPrsRaporTipi in 'Forms\InputForms\ufrmAyarPrsRaporTipi.pas' {frmAyarPersonelRaporTipi},
  Ths.Erp.Database.Table.AyarPrsIzinTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsIzinTipi.pas',
  ufrmAyarPrsIzinTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsIzinTipleri.pas' {frmAyarPersonelIzinTipleri},
  ufrmAyarPrsIzinTipi in 'Forms\InputForms\ufrmAyarPrsIzinTipi.pas' {frmAyarPersonelIzinTipi},
  Ths.Erp.Database.Table.AyarPrsMedeniDurum in 'BackEnd\Ths.Erp.Database.Table.AyarPrsMedeniDurum.pas',
  ufrmAyarPrsMedeniDurumlar in 'Forms\OutputForms\DbGrid\ufrmAyarPrsMedeniDurumlar.pas' {frmAyarPersonelMedeniDurumlar},
  ufrmAyarPrsMedeniDurum in 'Forms\InputForms\ufrmAyarPrsMedeniDurum.pas' {frmAyarPersonelMedeniDurum},
  Ths.Erp.Database.Table.AyarPrsYabanciDil in 'BackEnd\Ths.Erp.Database.Table.AyarPrsYabanciDil.pas',
  ufrmAyarPrsYabanciDiller in 'Forms\OutputForms\DbGrid\ufrmAyarPrsYabanciDiller.pas' {frmAyarPersonelDilleri},
  ufrmAyarPrsYabanciDil in 'Forms\InputForms\ufrmAyarPrsYabanciDil.pas' {frmAyarPersonelDil},
  Ths.Erp.Database.Table.AyarPrsYabanciDilSeviyesi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsYabanciDilSeviyesi.pas',
  ufrmAyarPrsYabanciDilSeviyeleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsYabanciDilSeviyeleri.pas' {frmAyarPersonelDilSeviyeleri},
  ufrmAyarPrsYabanciDilSeviyesi in 'Forms\InputForms\ufrmAyarPrsYabanciDilSeviyesi.pas' {frmAyarPersonelDilSeviyesi},
  ...
  Ths.Erp.Database.Table.AyarPrsEhliyetTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsEhliyetTipi.pas',
  ufrmAyarPrsEhliyetTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsEhliyetTipleri.pas' {frmAyarPersonelEhliyetTipleri},
  ufrmAyarPrsEhliyetTipi in 'Forms\InputForms\ufrmAyarPrsEhliyetTipi.pas' {frmAyarPersonelEhliyetTipi},
  Ths.Erp.Database.Table.AyarPrsMykTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsMykTipi.pas',
  ufrmAyarPrsMykTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsMykTipleri.pas' {frmAyarPersonelMykTipleri},
  ufrmAyarPrsMykTipi in 'Forms\InputForms\ufrmAyarPrsMykTipi.pas' {frmAyarPersonelMykTipi},
  Ths.Erp.Database.Table.AyarPrsSrcTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsSrcTipi.pas',
  ufrmAyarPrsSrcTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsSrcTipleri.pas' {frmAyarPersonelSrcTipleri},
  ufrmAyarPrsSrcTipi in 'Forms\InputForms\ufrmAyarPrsSrcTipi.pas' {frmAyarPersonelSrcTipi},
  Ths.Erp.Database.Table.AyarPrsAyrilmaNedeni in 'BackEnd\Ths.Erp.Database.Table.AyarPrsAyrilmaNedeni.pas',
  ufrmAyarPrsAyrilmaNedenleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsAyrilmaNedenleri.pas' {frmAyarPersonelAyrilmaNedeniTipleri},
  ufrmAyarPrsAyrilmaNedeni in 'Forms\InputForms\ufrmAyarPrsAyrilmaNedeni.pas' {frmAyarPersonelAyrilmaNedeniTipi},
  Ths.Erp.Database.Table.AyarPrsMektupTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsMektupTipi.pas',
  ufrmAyarPrsMektupTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsMektupTipleri.pas' {frmAyarPersonelMektupTipleri},
  ufrmAyarPrsMektupTipi in 'Forms\InputForms\ufrmAyarPrsMektupTipi.pas' {frmAyarPersonelMektupTipi},
  Ths.Erp.Database.Table.AyarPrsTatilTipi in 'BackEnd\Ths.Erp.Database.Table.AyarPrsTatilTipi.pas',
  ufrmAyarPrsTatilTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarPrsTatilTipleri.pas' {frmAyarPersonelTatilTipleri},
  ufrmAyarPrsTatilTipi in 'Forms\InputForms\ufrmAyarPrsTatilTipi.pas' {frmAyarPersonelTatilTipi},
  ...
  Ths.Erp.Database.Table.SysTaxpayerType in 'BackEnd\Ths.Erp.Database.Table.SysTaxpayerType.pas',
  ufrmSysTaxpayerTypes in 'Forms\OutputForms\DbGrid\ufrmSysTaxpayerTypes.pas' {frmSysTaxPayerTypes},
  ufrmSysTaxpayerType in 'Forms\InputForms\ufrmSysTaxpayerType.pas' {frmSysTaxpayerType},
  ...
  Ths.Erp.Database.Table.Arac.Arac in 'BackEnd\Ths.Erp.Database.Table.Arac.Arac.pas',
  ...
  ufrmHelperSysCountry in 'Forms\OutputForms\Helper\ufrmHelperSysCountry.pas' {frmHelperSysCountry},
  ufrmHelperSysCity in 'Forms\OutputForms\Helper\ufrmHelperSysCity.pas' {frmHelperSysCity},
  ...
  ufrmHelperAyarPrsBolum in 'Forms\OutputForms\Helper\ufrmHelperAyarPrsBolum.pas' {frmHelperAyarPrsBolum},
  ufrmHelperAyarPrsPersonelTipi in 'Forms\OutputForms\Helper\ufrmHelperAyarPrsPersonelTipi.pas' {frmHelperAyarPrsPersonelTipi},
  ufrmHelperAyarPrsBirim in 'Forms\OutputForms\Helper\ufrmHelperAyarPrsBirim.pas' {frmHelperAyarPrsBirim},
  ufrmHelperAyarPrsGorev in 'Forms\OutputForms\Helper\ufrmHelperAyarPrsGorev.pas' {frmHelperAyarPrsGorev},
  ufrmHelperAyarPrsCinsiyet in 'Forms\OutputForms\Helper\ufrmHelperAyarPrsCinsiyet.pas' {frmHelperAyarPrsCinsiyet},
  ufrmHelperAyarPrsAskerlikDurumu in 'Forms\OutputForms\Helper\ufrmHelperAyarPrsAskerlikDurumu.pas' {frmHelperAyarPrsAskerlikDurumu},
  ufrmHelperAyarPrsMedeniDurum in 'Forms\OutputForms\Helper\ufrmHelperAyarPrsMedeniDurum.pas' {frmHelperAyarPrsMedeniDurum},
  ufrmHelperPersonelTasimaServisi in 'Forms\OutputForms\Helper\ufrmHelperPersonelTasimaServisi.pas' {frmHelperPersonelTasimaServisi},
  ufrmHelperSysTaxpayerType in 'Forms\OutputForms\Helper\ufrmHelperSysTaxpayerType.pas' {frmHelperSysTaxpayerType},
  ufrmHelperSysLang in 'Forms\OutputForms\Helper\ufrmHelperSysLang.pas' {frmHelperSysLang},
  ufrmHelperStokCinsAileleri in 'Forms\OutputForms\Helper\ufrmHelperStokCinsAileleri.pas' {frmHelperStokCinsAileleri},
  Ths.Erp.Database.Table.Arac.YetkiliSurucu in 'BackEnd\AracTakip\Ths.Erp.Database.Table.Arac.YetkiliSurucu.pas',
  Ths.Erp.Database.Table.Arac.BakimBilgisi in 'BackEnd\AracTakip\Ths.Erp.Database.Table.Arac.BakimBilgisi.pas',
  Ths.Erp.Database.Table.Arac.Hareket in 'BackEnd\AracTakip\Ths.Erp.Database.Table.Arac.Hareket.pas',
  ufrmHelperAyarVergiOranlari in 'Forms\OutputForms\Helper\ufrmHelperAyarVergiOranlari.pas' {frmHelperAyarVergiOranlari},
  Ths.Erp.Database.Table.AyarStkUrunTipi in 'BackEnd\Ths.Erp.Database.Table.AyarStkUrunTipi.pas',
  ufrmAyarStkUrunTipleri in 'Forms\OutputForms\DbGrid\ufrmAyarStkUrunTipleri.pas' {frmAyarStkUrunTipleri},
  ufrmAyarStkUrunTipi in 'Forms\InputForms\ufrmAyarStkUrunTipi.pas' {frmAyarStkUrunTipi},
  ufrmHelperHesapPlani in 'Forms\OutputForms\Helper\ufrmHelperHesapPlani.pas' {frmHelperHesapPlani},
  Ths.Erp.Database.Table.AyarEFaturaKimlikSemasi in 'BackEnd\Ths.Erp.Database.Table.AyarEFaturaKimlikSemasi.pas',
  ufrmAyarEFaturaKimlikSemalari in 'Forms\OutputForms\DbGrid\ufrmAyarEFaturaKimlikSemalari.pas',
  ufrmAyarEFaturaKimlikSemasi in 'Forms\InputForms\ufrmAyarEFaturaKimlikSemasi.pas' {frmAyarEFaturaKimlikSemasi};
