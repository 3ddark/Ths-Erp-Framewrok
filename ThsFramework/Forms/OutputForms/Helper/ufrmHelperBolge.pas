...
procedure TfrmHelperBolge.FormClose(Sender: TObject;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        then
        begin
          TEdit(Owner).Text := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(TBolge(Table).BolgeAdi.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(TBolge(Table).BolgeAdi.FieldName).Value);
