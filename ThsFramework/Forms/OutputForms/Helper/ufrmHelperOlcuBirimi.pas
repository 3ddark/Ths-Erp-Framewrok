  ...
  begin
    ...
    begin
      ...
      begin
        ...
        then
        begin
          TthsCombobox(Owner).Text := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(TOlcuBirimi(Table).Birim.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(TOlcuBirimi(Table).Birim.FieldName).Value);
