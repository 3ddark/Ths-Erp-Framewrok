...
begin
  ...
  THesapKarti(Table).Yetkili1.Value := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili1.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili1.FieldName).Value);
  THesapKarti(Table).Yetkili1Tel.Value := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili1Tel.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili1Tel.FieldName).Value);
  THesapKarti(Table).Yetkili2.Value := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili2.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili2.FieldName).Value);
  THesapKarti(Table).Yetkili2Tel.Value := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili2Tel.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Yetkili2Tel.FieldName).Value);
  ...
  THesapKarti(Table).Iban.Value := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Iban.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).Iban.FieldName).Value);
  THesapKarti(Table).IbanPara.Value := FormatedVariantVal(dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).IbanPara.FieldName).DataType, dbgrdBase.DataSource.DataSet.FindField(THesapKarti(Table).IbanPara.FieldName).Value);
end;
